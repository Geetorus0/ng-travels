...
export const RouteLoader: React.FC<RouteLoaderProps> = ({
  ...
  return (
    <div className={cn("w-full py-8 flex flex-col items-center justify-center space-y-3", className)}>
      <div className="relative w-48 h-1.5 bg-card rounded-full overflow-hidden border border-border">
      ...
      {message && (
        <span className="text-[11px] font-mono text-muted-foreground tracking-wide flex items-center gap-1.5">
